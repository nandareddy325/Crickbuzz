        ...
        <div className="container loginpage align-content-center">
            ...
            <div className="col-4 m-auto">
                <form className=" p-3 bg-light ">
                    ...
                    <div className="">
                        <input type="email" name="email" className="form-control shadow-none m-2" autoComplete="off" value={email} placeholder="Enter Email" onChange={changeHandler} />
                        {/* <i class="fa-regular fa-envelope"></i>  <br/> */}
                    </div>
                    <div>
                    <input type="password" name="password"  className="form-control shadow-none  m-2" autoComplete="new-password" value={password} placeholder="Enter Password" onChange={changeHandler}/>
